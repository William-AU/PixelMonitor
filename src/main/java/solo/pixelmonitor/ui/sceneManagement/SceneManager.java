...
public class SceneManager {
    ...
    @Autowired
    public SceneManager(NavigationPanel navigationPanel, List<SceneChangeListener> sceneChangeListeners, List<ApplicationClosedListener> applicationClosedListeners, PixelViewerSceneContent pixelViewerSceneContent, ConfigSceneContent configSceneContent, ImageCompareSceneContent imageCompareSceneContent) {
